...
function SpiritSection({ setIsStoryOpen }) {
  ...
  const stories = [
    { num: '01', title: '"两弹一星"精神', img: ['stories/image1.png'], desc: '1999年9月18日，在庆祝中华人民共和国成立50周年之际，中共中央、国务院及中央军委隆重表彰了为研制"两弹一星"作出突出贡献的23位科技专家，并首次将这一伟大壮举中孕育的精神概括为"两弹一星"精神。这一精神诞生于新中国面临严峻国际形势的特殊时期，体现了中华民族在极端困难条件下自主创新的坚定信念。' },
    { num: '02', title: '"承书风范"三次"我愿意"', img: ['stories/image2.png', 'stories/image3.png'], desc: '王承书（1912-1994），我国稀有气体扩散法分离铀同位素理论的奠基者。1956年新中国成立初期，王承书放弃美国优越条件，冲破重重阻挠回到祖国。1958年面对苏联专家断言"中国没人懂分离铀同位素理论"，钱三强问她能否搞这个项目？她毅然回答："我愿意。"从此隐姓埋名投身核工业。1961年被调入核武器研究所，面对更艰巨的任务，她再次回答："我愿意。"1964年在原子弹爆炸前夕，她承担了核心数据计算的"收尾"工作，第三次回答："我愿意。"晚年身患多病，视力衰退，为了审阅论文，她用放大镜把字迹描深。遗嘱中将毕生积蓄10万元全部捐出，遗体捐献给医学研究。展现了老一辈科学家淡泊名利、甘为人梯的纯粹人格和对祖国的无限忠诚。' },
    { num: '03', title: '"粉身碎骨"不是形容词', img: ['stories/image4.png', 'stories/image7.png', 'stories/image8.png', 'stories/image11.png', 'stories/image12.png'], desc: '在青海金银滩221厂（西北核武器研制基地）那片被风雪肆虐的荒原上，对于魏世杰（"核司令"）、王淦昌（化名"王京"）等老一辈核工业人来说，"粉身碎骨"从来都不是文学作品中用来渲染悲壮的修辞，而是每一次核试验中必须直面的真实梦魇。那是一个没有现代精密远程遥控技术的年代，为了获取核爆炸瞬间最核心的物理参数，往往需要科研人员深入最危险的爆心区域。魏世杰曾回忆，在多次核试验的关键时刻，王淦昌等科学家总是坚持亲临一线指挥，甚至亲自参与回收实验装置。他们深知，一旦操作稍有差池或计算出现毫厘之谬，等待他们的就是瞬间的气化与毁灭。但在那个为了国家挺起脊梁的特殊岁月里，为了拿到第一手实验数据，为了验证理论的准确性，他们早已将个人生死置之度外。这种在极度危险面前展现出的科研勇气与献身精神，正是"两弹一星"精神中最令人动容的底色——用血肉之躯，为新中国铸就了坚不可摧的核盾牌。' },
    { num: '04', title: '用血肉之躯护住绝密资料', img: ['stories/image5.png'], desc: '人物：郭永怀（力学家、应用数学家）。时间与地点：1968年12月5日，北京首都机场。事件细节：郭永怀从青海基地出差返回，飞机在降落时发生事故坠毁。救援人员清理现场时，发现郭永怀和他的警卫员紧紧抱在一起。两具烧焦的遗体中间，那个装有绝密科研数据的公文包完好无损。他是唯一一位以烈士身份被追授"两弹一星"功勋奖章的科学家，用生命诠释了"事业高于一切"的核工业精神。' },
    { num: '05', title: '戈壁滩上的"百日会战"与秃头笑话', img: ['stories/image6.png', 'stories/image13.png', 'stories/image14.png'], desc: '人物：于敏（"氢弹之父"）、孙和夫等。1965年，于敏带领团队在上海华东计算技术研究所展开了氢弹原理的验证计算。在当时我国仅有两台大型电子计算机的条件下，于敏团队不畏艰难，利用有限的资源，经过100天的不懈努力，终于完成了前所未有的复杂计算。他们发现了氢弹自持热核燃烧的关键点，并成功提出了"于敏构型"。1965年9月—11月，氢弹原理探索陷入僵局，于敏带领团队远赴上海，利用每秒5万次的计算机，进行了持续100个昼夜的高强度计算，史称"百日会战"。在这100天里，科研人员轮班倒，机器不停，人也不停。由于长期处于高度紧张和高压的计算状态，许多人的头发大把脱落。人文细节：在突破成功的庆祝会上，于敏为了缓解大家长期熬夜的疲惫，讲了一个"三个头发的人去理发"的笑话，因为当时在场的科研人员大多因为过度劳累而脱发。展现了科研工作者在高压环境下的革命乐观主义精神与团队凝聚力。' },
    { num: '06', title: '80度开水与夹生馒头', img: ['stories/image9.png', 'stories/image15.png', 'stories/image16.png', 'stories/image17.png', 'stories/image18.png'], desc: '核心地点：青海高原·金银滩（西北核武器研制基地221厂），平均海拔高达3200米。代表人物：魏世杰及广大扎根高原的核工业建设者、科研人员。由于海拔高、气压低，水的沸点被强行拉低到了80多度。这意味着，无论火烧得多旺，水温永远达不到100度。在这个温度下，不仅馒头蒸不熟（常常是外面软、里面夹生，甚至冻成冰疙瘩），连煮面条都成了奢望。更致命的是高原缺氧，科研人员晚上睡觉时常被憋醒，必须坐起来大口喘气，或者吸几口氧气罐才能勉强入睡。白天工作时，稍微走快几步就会气喘吁吁、心跳加速。在基地初创的严冬，气温低至零下三四十度。为了抢时间，许多建设者没有营房，只能在冻土上挖坑，上面盖上茅草和泥土，搭起"地窝子"当宿舍。晚上睡觉时，大家必须戴着棉帽，穿着棉衣，但早上醒来，眉毛和胡须上依然结满了白霜。到了春天，狂风卷着黄沙肆虐，大家端着饭碗吃饭时，风沙直往碗里灌，咬一口馒头，常常是"一口饭，半口沙"。核武器研制不仅仅是实验室里的精密计算，更是与极端恶劣自然环境的殊死搏斗。"战高斗寒，笑谈渴饮苦水浆"，老一辈核工业人硬是用血肉之躯，在被称为"生命禁区"的高原上，为共和国铸就了最坚固的核盾牌。' },
    { num: '07', title: '10元奖金与"失踪的人"', img: ['stories/image10.png'], desc: '时间：1985年（原子弹项目获得国家科技进步特等奖）。奖金细节：奖金总额为1万元（当时是巨款），但参与研制的人员多达上万人。经过层层分配，绝大多数基层科研人员只分到了10元钱。隐姓埋名：为了保密，许多科研人员在20多年里音讯全无，老家的父母以为儿子早已牺牲，甚至收到了"烈士通知书"。展现了"干惊天动地事，做隐姓埋名人"的无私奉献与不计名利的高尚品格。' },
    { num: '08', title: '全国大协作的"651"计划', img: ['stories/image11.png', 'stories/image12.png'], desc: '时间：1965年。事件：代号"651"的人造卫星研制计划启动。协作规模：在西方封锁下，中央特批2亿元专款。全国29个省市自治区、1000多家单位、数十万科技人员和民兵参与。为了保障通讯，全国各地动员了60多万民兵日夜守护通讯线路。这是社会主义制度"集中力量办大事"优势的极致体现，展现了全国一盘棋的协同力量。' },
    { num: '09', title: '赫鲁晓夫的断言与"争气弹"', img: ['stories/image13.png', 'stories/image14.png'], desc: '时间：1959年6月。历史背景：苏联领导人赫鲁晓夫在撤走专家前曾傲慢地断言："离开我们，你们20年也造不出原子弹。"中国回应：中国科研人员顶着三年困难时期（1959-1961）的饥饿和浮肿，没有计算机，就用算盘和计算尺进行理论计算。历史时刻：1964年10月16日，中国第一颗原子弹成功爆炸，仅仅用了5年时间，狠狠打了赫鲁晓夫的脸，这颗原子弹也被亲切地称为"争气弹"。体现了中华民族自力更生、艰苦奋斗的民族精神和科技自立自强的坚定信念。' },
    { num: '10', title: '跨越时代的"精神基因"传承', img: ['stories/image15.png', 'stories/image16.png', 'stories/image17.png', 'stories/image18.png'], desc: '时间跨度：1950年代-2020年代。过去：老一辈在戈壁滩住帐篷、喝苦水，用算盘计算核数据。现在：新一代核工业人邢继（"华龙一号"总设计师）带领团队打造了具有完全自主知识产权的三代核电技术；徐銤院士坚守半个世纪，实现了中国实验快堆的成功并网发电。从"两弹一星"到"华龙一号"，变的是技术水平和硬件设施，不变的是"事业高于一切、责任重于一切、严细融入一切、进取成就一切"的核工业精神。关键核心技术是要不来、买不来、讨不来的，必须坚持自主创新，传承和弘扬核工业精神。' },
  ];
  return (
    <>
      ...
      <div className="flex flex-col gap-8 reveal-section" ref={addToRefs}>
        {stories.map((story, idx) => (
          <div key={idx} className={`flex flex-col ${idx % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-stretch bg-white/[0.01] backdrop-blur-md border border-white/[0.06] hover:border-cyan-500/30 rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-0.5 group`}>
            <div className="w-full lg:w-auto lg:max-w-[40%] bg-[#0a101d] overflow-hidden shrink-0 flex items-start justify-center relative">
              <img src={base + story.img[0]} alt={story.title} className="w-full lg:w-auto lg:h-full max-h-[300px] lg:max-h-[320px] object-contain group-hover:scale-105 transition-transform duration-700" />
              {story.img.length > 1 && <span className="absolute bottom-2 right-2 text-[8px] text-white/30 bg-black/60 px-2 py-0.5 rounded-full font-ui">+{story.img.length - 1}</span>}
            </div>
