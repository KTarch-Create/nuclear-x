...
function SpiritSection({ setIsStoryOpen }) {
  ...
  const stories = [
    { num: '01', title: '"两弹一星"精神', img: ['stories/image1.png', 'stories/image2.png'], desc: '1999年9月18日，在庆祝中华人民共和国成立50周年之际，中共中央、国务院及中央军委隆重表彰了为研制"两弹一星"作出突出贡献的23位科技专家，并首次将这一伟大壮举中孕育的精神概括为"两弹一星"精神。这一精神诞生于新中国面临严峻国际形势的特殊时期，体现了中华民族在极端困难条件下自主创新的坚定信念。' },
    { num: '02', title: '"承书风范"三次"我愿意"', img: ['stories/image3.png', 'stories/image4.png', 'stories/image5.png'], desc: '王承书（1912-1994），我国稀有气体扩散法分离铀同位素理论的奠基者。1956年新中国成立初期，王承书放弃美国优越条件，冲破重重阻挠回到祖国。1958年面对苏联专家断言"中国没人懂分离铀同位素理论"，钱三强问她能否搞这个项目？她毅然回答："我愿意。"从此隐姓埋名投身核工业。1961年被调入核武器研究所，面对更艰巨的任务，她再次回答："我愿意。"1964年在原子弹爆炸前夕，她承担了核心数据计算的"收尾"工作，第三次回答："我愿意。"晚年身患多病，视力衰退，为了审阅论文，她用放大镜把字迹描深。遗嘱中将毕生积蓄10万元全部捐出，遗体捐献给医学研究。展现了老一辈科学家淡泊名利、甘为人梯的纯粹人格和对祖国的无限忠诚。' },
    { num: '03', title: '"粉身碎骨"不是形容词', img: ['stories/image6.png', 'stories/image7.png', 'stories/image8.png', 'stories/image9.png', 'stories/image10.png', 'stories/image11.png'], desc: '在青海金银滩221厂（西北核武器研制基地）那片被风雪肆虐的荒原上，对于魏世杰（"核司令"）、王淦昌（化名"王京"）等老一辈核工业人来说，"粉身碎骨"从来都不是文学作品中用来渲染悲壮的修辞，而是每一次核试验中必须直面的真实梦魇。那是一个没有现代精密远程遥控技术的年代，为了获取核爆炸瞬间最核心的物理参数，往往需要科研人员深入最危险的爆心区域。魏世杰曾回忆，在多次核试验的关键时刻，王淦昌等科学家总是坚持亲临一线指挥，甚至亲自参与回收实验装置。他们深知，一旦操作稍有差池或计算出现毫厘之谬，等待他们的就是瞬间的气化与毁灭。但在那个为了国家挺起脊梁的特殊岁月里，为了拿到第一手实验数据，为了验证理论的准确性，他们早已将个人生死置之度外。这种在极度危险面前展现出的科研勇气与献身精神，正是"两弹一星"精神中最令人动容的底色——用血肉之躯，为新中国铸就了坚不可摧的核盾牌。' },
    { num: '04', title: '用血肉之躯护住绝密资料', img: ['stories/image12.png', 'stories/image13.png', 'stories/image14.png'], desc: '人物：郭永怀（力学家、应用数学家）。时间与地点：1968年12月5日，北京首都机场。事件细节：郭永怀从青海基地出差返回，飞机在降落时发生事故坠毁。救援人员清理现场时，发现郭永怀和他的警卫员紧紧抱在一起。两具烧焦的遗体中间，那个装有绝密科研数据的公文包完好无损。他是唯一一位以烈士身份被追授"两弹一星"功勋奖章的科学家，用生命诠释了"事业高于一切"的核工业精神。' },
    { num: '05', title: '戈壁滩上的"百日会战"与秃头笑话', img: ['stories/image15.png', 'stories/image16.png', 'stories/image17.png', 'stories/image18.png'], desc: '人物：于敏（"氢弹之父"）、孙和夫等。1965年，于敏带领团队在上海华东计算技术研究所展开了氢弹原理的验证计算。在当时我国仅有两台大型电子计算机的条件下，于敏团队不畏艰难，利用有限的资源，经过100天的不懈努力，终于完成了前所未有的复杂计算。他们发现了氢弹自持热核燃烧的关键点，并成功提出了"于敏构型"。1965年9月—11月，氢弹原理探索陷入僵局，于敏带领团队远赴上海，利用每秒5万次的计算机，进行了持续100个昼夜的高强度计算，史称"百日会战"。在这100天里，科研人员轮班倒，机器不停，人也不停。由于长期处于高度紧张和高压的计算状态，许多人的头发大把脱落。人文细节：在突破成功的庆祝会上，于敏为了缓解大家长期熬夜的疲惫，讲了一个"三个头发的人去理发"的笑话，因为当时在场的科研人员大多因为过度劳累而脱发。展现了科研工作者在高压环境下的革命乐观主义精神与团队凝聚力。' },
